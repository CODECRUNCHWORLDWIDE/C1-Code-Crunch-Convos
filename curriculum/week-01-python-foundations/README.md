...
| [exercises/exercise-01-hello-world.md](./exercises/exercise-01-hello-world.md) | Print your first message |
| [exercises/exercise-02-repl-explorer.md](./exercises/exercise-02-repl-explorer.md) | Drive the REPL like a calculator |
| [exercises/exercise-03-script-vs-repl.md](./exercises/exercise-03-script-vs-repl.md) | Compare running modes |
...
| [homework/problem-01-verify-your-install.md](./homework/problem-01-verify-your-install.md) | Prove Python is installed and reachable |
| [homework/problem-02-project-skeleton-with-a-venv.md](./homework/problem-02-project-skeleton-with-a-venv.md) | A repo, a venv, and a `.gitignore` in the right order |
| [homework/problem-03-a-tiny-script-with-comments-and-a-docstring.md](./homework/problem-03-a-tiny-script-with-comments-and-a-docstring.md) | Docstrings, comments, and type hints |
| [homework/problem-04-install-and-freeze-a-package.md](./homework/problem-04-install-and-freeze-a-package.md) | `pip install`, `pip freeze`, and a reproducible environment |
| [homework/problem-05-publish-your-repo-to-github.md](./homework/problem-05-publish-your-repo-to-github.md) | Remotes, tokens, and your first push |
| [homework/problem-06-combine-everything-with-a-small-cli.md](./homework/problem-06-combine-everything-with-a-small-cli.md) | A small interactive day planner |
