...
├── exercises/
│   ├── README.md
│   ├── exercise-01-hello-flask.md
│   ├── exercise-02-multiple-routes.md
│   ├── exercise-03-template-loop.md
│   └── exercise-04-form-echo.md
├── challenges/
│   ├── README.md
...
├── homework/
│   ├── README.md
│   ├── problem-01-custom-404-page.md
│   ├── problem-02-base-template.md
│   ├── problem-03-weather-route.md
│   ├── problem-04-post-tags.md
│   ├── problem-05-search-filter.md
│   └── problem-06-session-auth-demo.md
└── mini-project/
    ├── README.md
    └── personal_blog.py
```
