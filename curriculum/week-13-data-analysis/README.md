...
| [exercises/exercise-01-numpy-arrays.md](./exercises/exercise-01-numpy-arrays.md) | Create arrays, vector math, broadcasting |
| [exercises/exercise-02-load-and-inspect.md](./exercises/exercise-02-load-and-inspect.md) | Jupyter notebook: load a small dataset, inspect it |
| [exercises/exercise-03-filter-and-sort.md](./exercises/exercise-03-filter-and-sort.md) | Filter passing grades and sort by score |
| [exercises/exercise-04-groupby.md](./exercises/exercise-04-groupby.md) | Sales by category — total + average |
| [exercises/exercise-05-plot.md](./exercises/exercise-05-plot.md) | Monthly totals bar chart, saved as PNG |
...
| [homework/README.md](./homework/README.md) | Six practice problems, one page each, every answer on its page |
| [mini-project/README.md](./mini-project/README.md) | Full spec for the dataset analysis notebook |
| [mini-project/starter.md](./mini-project/starter.md) | Scaffolded notebook to work from, cell by cell — dependency list included |
