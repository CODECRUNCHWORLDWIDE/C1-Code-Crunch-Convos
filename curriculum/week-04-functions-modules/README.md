...
## Schedule (roughly 38 hours of work)

| Day | Activity | Time | Deliverable |
|-----|----------|------|-------------|
| Mon | Read lecture note 1 (defining functions) | 2 h | Notes in your journal |
| Mon | Exercise 01 (function basics) | 1.5 h | `exercise-01-function-basics.md` |
| Tue | Read lecture note 2 (`*args`/`**kwargs`, scope) | 2.5 h | Notes |
| Tue | Exercise 02 (`*args`/`**kwargs`) | 1.5 h | `exercise-02-args-kwargs.md` |
| Wed | Read lecture note 3 (recursion) | 2 h | Notes |
| Wed | Exercise 03 (recursion intro) | 2 h | `exercise-03-recursion-intro.md` |
| Wed | Exercise 04 (scope mystery) | 1.5 h | Fixed script |
| Thu | Read lecture note 3 (modules & imports) | 2 h | Notes |
| Thu | Exercise 05 (stdlib imports) | 1.5 h | `exercise-05-import-and-use.md` |
...
- [Lecture note 3 — Recursion](./lecture-notes/03-recursion.md)
- [Lecture note 4 — Modules and imports](./lecture-notes/04-modules-and-imports.md)
- [Exercises index](./exercises/README.md)
- [Challenges index](./challenges/README.md)
- [Quiz](./quiz.md)
- [Homework](./homework/README.md)
  - [Problem 1 — Temperature module](./homework/problem-01-temperature-module.md)
  - [Problem 2 — Password strength](./homework/problem-02-password-strength.md)
  - [Problem 3 — Leap year function with tests](./homework/problem-03-leap-year-function-with-tests.md)
  - [Problem 4 — Recursive sum](./homework/problem-04-recursive-sum.md)
  - [Problem 5 — Dict builder](./homework/problem-05-dict-builder.md)
  - [Problem 6 — Importing from a custom module](./homework/problem-06-importing-from-a-custom-module.md)
