...
- **Homework** — [`homework/README.md`](./homework/README.md) (6 problems, one page each, due before Week 7)
  - [Problem 1 — Word-count CLI](./homework/problem-01-word-count-cli.md)
  - [Problem 2 — CSV merger](./homework/problem-02-csv-merger.md)
  - [Problem 3 — JSON pretty-printer](./homework/problem-03-json-pretty-printer.md)
  - [Problem 4 — Retry-on-error decorator](./homework/problem-04-retry-on-error-decorator-preview-of-decorators.md)
  - [Problem 5 — File watcher (poll-based)](./homework/problem-05-file-watcher-poll-based.md)
  - [Problem 6 — Atomic-save helper](./homework/problem-06-atomic-save-helper.md)
- **Mini-project** — [`mini-project/README.md`](./mini-project/README.md) (the capstone for this week)
...
3. **Atomic writes** — implement a context manager `atomic_write(path)` that writes to a temp file and renames on success. We preview this in [homework problem 6](./homework/problem-06-atomic-save-helper.md).
...
- [ ] Submitted all six [homework problems](./homework/README.md)
