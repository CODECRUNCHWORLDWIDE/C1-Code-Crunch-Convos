...
├── exercises/
│   ├── README.md
│   ├── exercise-01-dog-class.md
│   ├── exercise-02-rectangle.md
│   ├── exercise-03-inheritance-shapes.md
│   ├── exercise-04-dataclass-user.md
│   └── exercise-05-bank-account.md
├── challenges/
│   ├── README.md
...
├── homework/
│   ├── README.md
│   ├── problem-01-bankaccount-with-interest.md
│   ├── problem-02-polygon-hierarchy.md
│   ├── problem-03-stack-built-on-a-list.md
│   ├── problem-04-simple-orm-like-model.md
│   ├── problem-05-observer-pattern-light.md
│   └── problem-06-unit-conversion-class.md
└── mini-project/
    ├── README.md
    └── library_system.py
```

Every problem page ships a runnable `-solution.py` beside it — the same
code the page shows under **The Solution**, as a download that cannot
collide with the file you write yourself.
