...
weighting is in [rubric.md](./08-rubric.md).
...
- [ ] **Comprehensive README** — purpose, install, usage, screenshots,
      contributing, license. See [lecture-notes/02-building-and-shipping.md](./02-lecture-notes/02-building-and-shipping.md)
      for the anatomy.
...
[rubric.md](./08-rubric.md). Read it on Day 1 — knowing how you will be graded
...
The full pre-submit walk-through is in [submission-checklist.md](./09-submission-checklist.md).
...
[resources.md](./01-resources.md). Skim it on Day 1; come back to it when you
get stuck.
...
1. [01-planning-your-capstone.md](./02-lecture-notes/01-planning-your-capstone.md)
   — picking and scoping a project, MVP thinking, anti-patterns.
2. [02-building-and-shipping.md](./02-lecture-notes/02-building-and-shipping.md)
   — repo conventions, README anatomy, CI, demos, deployment.
3. [03-presentation-and-portfolio.md](./02-lecture-notes/03-presentation-and-portfolio.md)
