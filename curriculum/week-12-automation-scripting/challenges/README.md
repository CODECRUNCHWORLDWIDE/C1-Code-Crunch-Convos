...
Two larger problems that combine multiple concepts. Each takes **1.5–3 hours**. Each challenge page carries its own worked answer under `## The Solution`, plus a downloadable `-solution.py` that proves itself offline — read it only after your own version runs.
