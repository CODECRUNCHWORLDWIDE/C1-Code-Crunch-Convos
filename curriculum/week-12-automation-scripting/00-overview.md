...
- **Lecture notes**: [`lecture-notes/`](./02-lecture-notes/)
- **Exercises** (guided, ~30 min each): [`exercises/`](./03-exercises/)
- **Challenges** (longer, integration-style): [`challenges/`](./04-challenges/)
- **Quiz**: [`quiz.md`](./05-quiz.md)
- **Homework** (6 problems): [`homework.md`](./06-homework.md)
- **Mini-project**: [`mini-project/`](./07-mini-project/)
- **External resources**: [`resources.md`](./01-resources.md)
