...
| [exercises/exercise-01-fizzbuzz.md](./exercises/exercise-01-fizzbuzz.md) | Classic FizzBuzz from 1 to 100 |
| [exercises/exercise-02-sum-evens.md](./exercises/exercise-02-sum-evens.md) | Sum even numbers from 1 to N |
| [exercises/exercise-03-password-checker.md](./exercises/exercise-03-password-checker.md) | Loop until the password meets the rules |
| [exercises/exercise-04-multiplication-table.md](./exercises/exercise-04-multiplication-table.md) | Print an N×N multiplication table |
| [exercises/exercise-05-find-prime.md](./exercises/exercise-05-find-prime.md) | Decide whether a number is prime |
...
| [homework/README.md](./homework/README.md) | Index of the six homework problems |
| [homework/problem-01-leap-year-checker.md](./homework/problem-01-leap-year-checker.md) | The Gregorian rule, and why the order of the tests is the answer |
| [homework/problem-02-count-vowels-in-a-string.md](./homework/problem-02-count-vowels-in-a-string.md) | The counting pattern, one character at a time |
| [homework/problem-03-reverse-a-number.md](./homework/problem-03-reverse-a-number.md) | Take a number apart with `% 10` and `// 10` |
| [homework/problem-04-sum-of-digits.md](./homework/problem-04-sum-of-digits.md) | The same traversal with a plainer accumulator |
| [homework/problem-05-fibonacci-numbers-up-to-n.md](./homework/problem-05-fibonacci-numbers-up-to-n.md) | A loop whose length you cannot know in advance |
| [homework/problem-06-simple-atm-menu.md](./homework/problem-06-simple-atm-menu.md) | A menu loop that refuses before it breaks the money |
| [mini-project/README.md](./mini-project/README.md) | Full spec for the number-guessing game |
| [mini-project/starter.md](./mini-project/starter.md) | Starter scaffold for the mini-project |
