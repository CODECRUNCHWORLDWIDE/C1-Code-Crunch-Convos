...
| [exercises/exercise-01-variable-swap.md](./exercises/exercise-01-variable-swap.md) | Swap two variables without a temporary |
| [exercises/exercise-02-string-formatter.md](./exercises/exercise-02-string-formatter.md) | Build a multi-line aligned f-string |
| [exercises/exercise-03-temperature-converter.md](./exercises/exercise-03-temperature-converter.md) | Celsius to Fahrenheit with type hints |
| [exercises/exercise-04-input-parsing.md](./exercises/exercise-04-input-parsing.md) | Read two numbers and print arithmetic results |
...
| [homework/problem-01-simple-interest-calculator.md](./homework/problem-01-simple-interest-calculator.md) | A five-line money report with the columns lined up |
| [homework/problem-02-bmi-calculator.md](./homework/problem-02-bmi-calculator.md) | Four category flags, decided without `if` |
| [homework/problem-03-word-and-character-counter.md](./homework/problem-03-word-and-character-counter.md) | Four statistics about a line, one method call each |
| [homework/problem-04-grade-letter-assigner-no-if.md](./homework/problem-04-grade-letter-assigner-no-if.md) | Five letter grades from a sum of comparisons |
| [homework/problem-05-compound-interest.md](./homework/problem-05-compound-interest.md) | `**`, precedence, and parentheses that carry the answer |
| [homework/problem-06-distance-and-speed-report.md](./homework/problem-06-distance-and-speed-report.md) | Unit conversion, a guard clause, and a two-width report |
