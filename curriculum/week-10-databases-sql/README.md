...
| Day       | Hours | Focus                                                                 |
|-----------|-------|-----------------------------------------------------------------------|
| Monday    | 6     | Read `lecture-notes/01`, complete `exercise-01-first-table.md`.       |
| Tuesday   | 6     | Practice SQL on sqlbolt.com, then `exercise-02-parameterized.md`.     |
| Wednesday | 6     | Read `lecture-notes/02`, complete `exercise-03-joins.md` and `04`.    |
| Thursday  | 6     | Read `lecture-notes/03`, complete `exercise-05-sqlalchemy-basic.md`.  |
...
- `homework/` — six longer problems to stretch the concepts, one page each.
  Start at `homework/README.md`.
- `resources.md` — official documentation and the books / tutorials we recommend.

Every problem page has a sibling `-solution.py` next to it — the finished
answer, runnable as downloaded. The page shows the same code, so the two can
never say different things. There is no separate answers folder: the answer to
a problem lives on the page that asked it.
